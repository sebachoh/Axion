  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '1rem', background: 'var(--glass-bg)', padding: '10px 16px', borderRadius: 'var(--radius-sm)', border: '1px solid var(--glass-border)' }}>
        ...
        <button onClick={() => setFilterPriority('medium')} style={{ background: filterPriority === 'medium' ? '#feca57' : 'transparent', color: filterPriority === 'medium' ? '#000' : 'rgba(255,255,255,0.6)', border: 'none', padding: '4px 12px', borderRadius: '12px', cursor: 'pointer', fontWeight: 600, fontSize: '0.8rem' }}>Media</button>
